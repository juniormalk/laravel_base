...
<h1>{{__('general.Employees')}} - {{$data['employee']->name}} - {{__('general.Documents')}} - {{__('general.Upload')}}</h1>

@stop

@section('content')

<a href="{{route('employees.documents', $data['employee']->id)}}" class="btn btn-app pull-right">
