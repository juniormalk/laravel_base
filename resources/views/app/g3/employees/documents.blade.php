					...
					<tr>
						...
						<td>
							...
							<div class="col-lg-1">
								...
								@if (Request::is('g3/branches*'))
									<a class="" href="{{route('branches.outsourceds.employees.documents.delivereds.add', [$employee->id, $document->id, $branch->id ])}}">
								@else
							...
							<div class="col-lg-11">
								...
								<table border="1" style="width: 98%;">
									...
									<tr>
										{{--d  --d($employee->id) --}}
										@foreach ($document->delivereds()->where('employee_id', $employee->id)->where('fl_deleted', 0)->orderBy('id', 'desc')->take(1)->get() as $delivered)
										...
										<td class="text-center" style="padding: 2px 5px;">
											...
											<a class="" href="{{route('branches.outsourceds.documents.delivereds.edit', [$employee->id, $delivered->id, $branch->id])}}" alt="upload"><i class="fa fa-pencil text-aqua" style="font-size: 16px"></i></a>
											@else
											<a class="" href="{{route('employees.documents.fileupload', [$employee->id, $delivered->id])}}" alt="upload"><i class="fa fa-upload text-aqua" style="font-size: 16px"></i></a> &nbsp&nbsp
