...
@yield('title', config('adminlte.title', 'Abaco Tecnologia'))
@yield('title_postfix', config('adminlte.title_postfix', ''))</title>
    ...
    @if(config('adminlte.plugins.datatables'))
        ...
        <link rel="stylesheet" href="//cdn.datatables.net/searchpanes/1.0.1/css/searchPanes.dataTables.min.css">
...
@if(config('adminlte.plugins.datatables'))
    ...
    <script src="//cdn.datatables.net/searchpanes/1.0.1/js/dataTables.searchPanes.min.js"></script>
